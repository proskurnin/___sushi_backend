...
<div class="container">
    <div class="row">
        ...
        <nav class="navbar navbar-dark">
            <!-- Brand -->
            <a class="navbar-brand" href="index.php">Суши-Бар №1</a>
            <!-- Links -->
        ...
        if ($showtype !== 'show_no' || isset($_GET['del']) || isset($_GET['edit_name']))
        {
            ...
            if ($showtype == 'show_edit')
            {
                ...
                echo "
                    ...
                    echo "
                                            <select class='form-control form-control-warning' id='recipe_type' name='recipe_type' required>
                    ...
                    echo "
                                            <select class='form-control form-control-warning' id='recipe_group' name='recipe_group' required>
                    ...
                    echo "
                                            <select class='form-control form-control-warning' id='recipe_view' name='recipe_view' required>
            ...
            else if ($showtype == 'show_mistake')
            {
                ...
                echo "
                    ...
                    echo "
                                            <select class='form-control form-control-success' id='recipe_type' name='recipe_type' required>
                                                <option value='{$editrecipe_type}'>{$editrecipe_type}</option>
                                                <optgroup label='Другие возможные типы:'>
                                                    {$recipe_type_list}
                                                </optgroup>
                    ...
                    echo "
                                            <select class='form-control form-control-success' id='recipe_group' name='recipe_group' required>
                                                <option value='{$editrecipe_group}'>{$editrecipe_group}</option>
                                                <optgroup label='Другие возможные группы:'>
                                                    {$recipe_group_list}
                                                </optgroup>
                    ...
                    echo "
                                            <select class='form-control form-control-success' id='recipe_view' name='recipe_view' required>
                                                <option value='{$editrecipe_view}'>{$editrecipe_view}</option>
                                                <optgroup label='Другие возможные виды:'>
                                                    {$recipe_view_list}
                                                </optgroup>
            ...
            else if ($showtype == 'show_manag' || isset($_GET['del']))
            {
                ...
                if ($event == 'event_first')
                {
                    ...
                    echo "
                                            <select class='form-control' id='recipe_group' name='recipe_group' required>
                    ...
                    echo "
                                            <select class='form-control' id='recipe_view' name='recipe_view' required>
