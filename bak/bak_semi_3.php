        ...
        echo "<div id='add_field_area'>";
            ...
            foreach ($values as $value) {
                ...
                if ($n == 1) {
                    ...
                    rowform($i,$event,$edit_name,$tabname);
