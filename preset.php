...
// и $name для отображения в поле Название элемента
...
// и $add_name для внесения в поле Название элемента
...
// На первом шагу определяем количество строк, которые используются в элементе для редактирования
...
//            ).'<br><br>';
    ...
    )
    {
        $error = 1;
        $dubl = 1;
        $reason = $reason . 'Название комплекта уже используется!\u000A';
        break;
    }
}
...
//     потому что не влезает по высоте на экран
            ...
            echo 'Строк в комплекте: <span style="color: red;">'.$num_rows.'</span><br>';
...
<div class="container">
    <div class="row">
        ...
        echo "<h1 class='display-1'>Комплекты</h1>";
        ...
        <div>
            ...
            <a href="preset.php" class="btn btn-primary">Комплекты</a>
        ...
        if ($showtype !== 'show_no' || isset($_GET['del']) || isset($_GET['edit_name']))
        {
            ...
            else if ($showtype == 'show_manag' || isset($_GET['del']))
            {
                ...
                if ($event == 'event_first')
                {
                    echo "
                                                <div class='form-group'>
                                                    <input type='text' placeholder='Название комплекта' class='col-xs-3 form-control' id='add_name' name='add_name' required>
                                                </div>";
                }
            ...
            else if ($showtype == 'show_manag' || isset($_GET['del']))
            {
                ...
                <div class='col-xs-6'>
                    ...
                    <button type='submit' name='addnewitem' class='btn btn-outline-primary pull-right'>Добавить комплект</button>
                </div>";
            }
